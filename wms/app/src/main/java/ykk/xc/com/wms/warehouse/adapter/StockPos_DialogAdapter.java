...
public class StockPos_DialogAdapter extends RecyclerView.Adapter<StockPos_DialogAdapter.MyViewHolder> {
    ...
    private List<stock_position> datas;//存放数据
    private Activity context;
    private OnItemClickListener2 mClickListener;

    public StockPos_DialogAdapter(Activity context, List<stock_position> datas) {
        this.datas = datas;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.wh_stock_pos_dialog_item, parent, false);
