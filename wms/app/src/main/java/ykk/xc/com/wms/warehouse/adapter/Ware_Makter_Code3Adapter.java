...
public class Ware_Makter_Code3Adapter extends BaseArrayRecyclerAdapter<stock_area> {

    private Activity context;
    private MyCallBack callBack;

    public Ware_Makter_Code3Adapter(Activity context, List<stock_area> datas) {
        super(datas);
    ...
    public int bindView(int viewtype) {
        return R.layout.wh_maker_code_item3;
    }

    @Override
    public void onBindHoder(RecyclerHolder holder, final stock_area entity, final int pos) {
            // 初始化id
    ...
    public interface MyCallBack {
        void onPrint(stock_area entity, int position);
    }
