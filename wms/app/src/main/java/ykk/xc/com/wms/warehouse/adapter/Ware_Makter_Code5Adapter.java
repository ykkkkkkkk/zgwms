...
public class Ware_Makter_Code5Adapter extends BaseArrayRecyclerAdapter<t_Department> {

    private Activity context;
    private MyCallBack callBack;

    public Ware_Makter_Code5Adapter(Activity context, List<t_Department> datas) {
        super(datas);
    ...
    public int bindView(int viewtype) {
        return R.layout.wh_maker_code_item5;
    }

    @Override
    public void onBindHoder(RecyclerHolder holder, final t_Department entity, final int pos) {
            // 初始化id
    ...
    public interface MyCallBack {
        void onPrint(t_Department entity, int position);
    }
