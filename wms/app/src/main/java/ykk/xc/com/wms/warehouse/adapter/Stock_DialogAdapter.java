...
public class Stock_DialogAdapter extends RecyclerView.Adapter<Stock_DialogAdapter.MyViewHolder> {
    ...
    private List<t_stock> datas;//存放数据
    private Activity context;
    private OnItemClickListener2 mClickListener;

    public Stock_DialogAdapter(Activity context, List<t_stock> datas) {
        this.datas = datas;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.wh_stock_dialog_item, parent, false);
